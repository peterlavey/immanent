...
- [x] **1.2 Basic 3D Environment**
  - [x] Create a main 3D scene (World.tscn) (Plan: 1.2) (Req: 1)
  - [x] Implement a fixed 2D camera (Isometric/Top-down) (Plan: 1.2) (Req: 1)
...
- [x] **2.2 Data Spots**
  ...
  - [x] Implement spawning logic (5 spots per iteration, 5 MB each initially) (Plan: 2.2) (Req: 4)
...
- [ ] **4.2 The Escape**
  - [ ] Implement the final win condition logic (Plan: 4.2) (Req: 8)
  - [ ] Final win screen/cutscene (Plan: 4.2) (Req: 8)
